...
- `data-pipeline/` - สคริปต์อัตโนมัติสำหรับแปลงไฟล์ภาพ `.tif` (จากดาวเทียม Sentinel-2 S2DR4) ให้เป็น XYZ Map Tiles (Python + Docker)
...
สคริปต์นี้เอาไว้แปลงรูป `.tif` ที่ดาวน์โหลดมาจาก Colab S2DR ให้กลายเป็นชิ้นแผนที่ย่อยๆ (Tiles) และนำส่งไปเก็บที่ Backend
